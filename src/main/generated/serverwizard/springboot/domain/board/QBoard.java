...
public class QBoard extends EntityPathBase<Board> {
    ...
    private static final long serialVersionUID = -1870532637L;
    ...
    public final serverwizard.springboot.domain.user.QUser user;
    ...
    public QBoard(Class<? extends Board> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new serverwizard.springboot.domain.user.QUser(forProperty("user")) : null;
    }
